  ...
  <script type="text/javascript">
    ...
    function saveReport() {
        ReportsDwr.saveReport(selectedReport.id, $get("name"), getReportPointIdsArray(), $get("includeEvents"),
                ...
                $get("includeData"), $get("zipData"), emailRecipients.createRecipientArray(), function(response), $get("chartTitle"), $get("yReferenceLine"), $get("xAxisTitle"), $get("yAxisTitle"), $get("isScatterPlot")  {
    ...
    function runReport() {
        ...
        ReportsDwr.runReport($get("name"), getReportPointIdsArray(), $get("includeEvents"),
                ...
                $get("fromYear"), $get("fromMonth"), $get("fromDay"), $get("fromHour"), $get("fromMinute"),
                $get("toNone"), $get("toYear"), $get("toMonth"), $get("toDay"), $get("toHour"), $get("toMinute"),
                $get("email"), $get("includeData"), $get("zipData"), emailRecipients.createRecipientArray(), function(response), $get("chartTitle"), $get("yReferenceLine"), $get("xAxisTitle"), $get("yAxisTitle"), $get(isScatterPlot) {
