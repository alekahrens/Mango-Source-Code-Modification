...
public class ReportVO implements Serializable {
	...
	private boolean scatterPlotChart;
    ...
    public void setScatterPlotChart(boolean scatterPlotChart){
    ...
    private void writeObject(ObjectOutputStream out) throws IOException {
		...
		out.writeUTF(chartTitle);
		out.writeBoolean(scatterPlotChart);
		out.writeUTF(xAxisTitle);
		out.writeUTF(yAxisTitle);
		out.writeInt(yReferenceLine);
    }
