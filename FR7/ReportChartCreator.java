...
public class ReportChartCreator {
     ...
     */
    private static final int IMAGE_WIDTH = 1030;
    private static final int IMAGE_HEIGHT = 800;
    public static final String IMAGE_CONTENT_ID = "reportChart.png";

    public static final int POINT_IMAGE_WIDTH = 8400;
    public static final int POINT_IMAGE_HEIGHT = 3500; // 340
    ...
    public void createContent(ReportInstance reportInstance, ReportDao reportDao, String inlinePrefix,
        ...
        StreamHandler handler = new StreamHandler(reportInstance.getReportStartTime(),
                reportInstance.getReportEndTime(), IMAGE_WIDTH*2, createExportFile, bundle);
        ...
        for (PointStatistics pointStat : pointStatistics) {
            ...
            if (ptsc.hasData()) {
                ...
                pointStat.setImageData(ImageChartUtils.getChartData(ptsc, POINT_IMAGE_WIDTH*2, POINT_IMAGE_HEIGHT*2));
            }
        }
        ...
        if (ptsc.hasData()) {
            ...
            imageData = ImageChartUtils.getChartData(ptsc, true, IMAGE_WIDTH*2, IMAGE_HEIGHT*2);
        }
