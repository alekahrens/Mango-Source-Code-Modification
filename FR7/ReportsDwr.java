...
public class ReportsDwr extends BaseDwr {
    ...
    public DwrResponseI18n saveReport(int id, String name, List<ReportPointVO> points, int includeEvents,
            ...
            String scheduleCron, boolean email, boolean includeData, boolean zipData,  List<RecipientListEntryBean> recipients, String chartTitle, int yReferenceLine, String xAxisTitle, String yAxisTitle, boolean isScatterPlot
           ) {
		...
		report.setChartTitle(chartTitle);
		report.setYReferenceLine(yReferenceLine);
		report.setXAxisTitle(xAxisTitle);
		report.setYAxisTitle(yAxisTitle);
		report.setScatterPlotChart(isScatterPlot);
    ...
    public DwrResponseI18n runReport(String name, List<ReportPointVO> points, int includeEvents,
            ...
            List<RecipientListEntryBean> recipients, String chartTitle, int yReferenceLine, String xAxisTitle, String yAxisTitle, boolean isScatterPlot) {
        DwrResponseI18n response = new DwrResponseI18n();
